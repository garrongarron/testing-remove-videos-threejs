 ...
 */
	...
	class Water extends THREE.Mesh {
		...
		constructor( geometry, options = {} ) {
			...
			const normalMap0 = options.normalMap0 || textureLoader.load( 'src/basic/environment/watertransparent/Water_1_M_Normal.jpg' );
			const normalMap1 = options.normalMap1 || textureLoader.load( 'src/basic/environment/watertransparent/Water_2_M_Normal.jpg' );
